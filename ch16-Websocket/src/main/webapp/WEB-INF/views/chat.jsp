...
<script type="text/javascript">
	...
	function connect() {
		wsocket = new WebSocket("ws://localhost:18080/ch16-Websocket/chat-ws.do");
	...
	<body>
		코드번호 : <input type="text" id="code"><br>
		...
		<br>
		<input type="text" id="message" disabled style="width:300px;">
